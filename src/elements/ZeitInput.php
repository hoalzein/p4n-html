...
class ZeitInput extends Elements {
    ...
    public function __construct($label = '', $name = '', $value = '', $other = 'onBlur="ti2(this);"', $ohnepo = false, $mitjs = false, $valsmcurrent = false, $onSelectCallback = null) {
        global $db;
        if ($name != '') {
