/*
 overlibmws_filter.js plug-in module - Copyright Foteos Macrides 2003-2008. All rights reserved.
  ...
  Initial: November 27, 2003 - Last Revised: January 16, 2008
...
if(!OLie55){if(!OLhasOp()){o3_filter=0;return;}if(parent!=self)o3_fadeout=0;}if(OLie55){o3_fadein-=1;o3_fadeout-=1;
OLfiIdx= -1;if(over.style.filter){var p,s,ob=over.filters[28];for(p=28;p<31;p++){over.filters[p].enabled=0;}
...
var o=(o2?over2:over),os=o.style;if(OLie4&&typeof os.filter=='string')os.filter='Alpha(opacity='+op+')';
...
if(!bkdrop&&!o)return;var os=(o)?o.style:bkdrop.style;if(OLie4&&typeof os.filter=='string')os.filter='Alpha(opacity='+op+')';
else if(typeof os.opacity!='undefined')os.opacity=op/100;else if(typeof os.MozOpacity!='undefined')os.MozOpacity=op/100;
else if(typeof os.KhtmlOpacity!='undefined')os.KhtmlOpacity=op/100;
}
...
t.apply();os.visibility='hidden';t.play();}}}OLfiIdx=-1;if(parent!=self&&o3_frame==parent){o3_fadein=-1,o3_fadeout=-1;
o3_filtershadow=0;o3_filteropacity=100;OLchkFilter(o,o2);}
}
...
function OLfadeOut2(){
var b=(OLshadowPI)?OLgetRef('backdrop2'):null;if(OLfOp2<0){clearInterval(OLfoId2);if(b){b.style.visibility="hidden";
if(over==over2)OLcleanUpShadow();}OLfoId2=0;OLhideObjectP2(over);over2.style.visibility='hidden';}else{var ops=0.3*OLfOp2;
if(b){if(OLfOp2>40)OLopOvSh(ops,b);else OLopOvSh(1,b);}OLopOv(OLfOp2,2);OLfOp2-=OLfInc2;}
}
